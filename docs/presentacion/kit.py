...
class Deck:
    # Copia de perf/lab/deck/kit.py del taller de carga, para que las presentaciones
    # del curso compartan el mismo sistema visual. Unico cambio: el pie es un parametro.
    def __init__(self, pie='Taller de pruebas de carga'):
        self.pie = pie
    ...
    def slide(self, title=None, kicker=None, notes=None):
        ...
        if self.n > 1:
            ...
            text(s, 0.6, 7.05, 8, 0.3, self.pie, size=10, color=C['muted'])
        if notes:
